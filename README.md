...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/flask-caching-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/flask-caching-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add flask-caching
# for installing globally
pixi global install flask-caching
```
...
It is possible to list all of the versions of `flask-caching` available on your platform:
...
```
pixi search flask-caching --channel conda-forge
```
